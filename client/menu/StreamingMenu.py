...
class StreamingMenu(Menu):
    ...
    def show(self):
        ...
        def video_stream():
            ...
            while True:
                try:
                    ...
                    npdata = np.fromstring(data.decode(), dtype=np.uint8)

                    frame = cv2.imdecode(npdata, 1)
                    frame = cv2.putText(frame, 'FPS: ' + str(fps), (10, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255),
                                        2)
        ...
        def audio_stream():
            ...
            socket_address = (host_ip, self.streaming_port)
